    ...
    <div id="drawtoolPanel" v-show="visible">
        <el-container>
            <el-header id="drawtoolHead">
                <span>基础标绘</span>
                <span class="closebtn miconfont icon-baocun" @click="saveGraphic">保存</span>
            </el-header>
            <el-main class="graphic-draw-main">
                <ul>
                    ...
                    <li>
                        <i
                                class="miconfont icon-cube icon-class"
                                title="添加立方体"
        ...
        <div class="graphic-edit" v-show="editMode">
            <div class="marker-edit-class edit-class" v-show="menuSelected['MARKER']">
                <el-color-picker v-model="markerColor" id="markerColor" show-alpha size="mini"
                                 title="文字颜色"></el-color-picker>
                <el-select
                        size="mini"
                        v-model="fontSize"
                        allow-create
            ...
            <div class="polygon-edit-class edit-class" v-show="menuSelected['BOX']">
                <el-color-picker
                        title="填充色"
                        id="boxColor"
                        v-model="polygonColor"
                ...
                <el-input title="立方体高度" size="mini" v-model="boxHeight" class="box-height" type="number"
                          placeholder="立方体高度"></el-input>
                <i
                        class="iconfont iconoutline border-btn"
                        :class="{'outline-selected':outline}"
                        title="边框"
            ...
            <div class="label-edit-class edit-class" v-show="menuSelected['LABEL']">
                ...
                <el-color-picker title="颜色" v-model="markerColor" id="labelColor" show-alpha
            ...
            <div class="model-edit-class edit-class" v-show="menuSelected['MODEL']">
                ...
                <el-color-picker title="颜色" id="modelColor" v-model="modelColor" show-alpha
                                 size="mini"></el-color-picker>
                <el-slider
...
<script>
    ...
    import {CesiumPolygon, CesiumBox} from "../core/Graphic";
    ...
    export default {
        ...
        methods: {
            ...
            saveGraphic() {
                ...
                let graphicJsons = this.$refs.layerManager.json;
                graphicJsons.forEach(graphicJson=>{
                    if(graphicJson.children && graphicJson.children.length>0){
                        let type = graphicJson.type
                        if (type === "marker" || type === "label") {
                            this.$refs.markerManager.export(type);
                        } else {
                            let graphicJson = graphicManager.save(type);
                        }
                    }
                })
            },
            ...
            setControlByEvent(e) {
                ...
                if (e.detail.graphicType === "POLYGON" || e.detail.graphicType === "BOX") {
                    ...
                    //this.boxHeight = e.detail.height;
            ...
            menuAction(menu) {
                checkComponent(this)
                const graphic = ["MARKER", "POLYLINE", "POLYGON", "BOX", "LABEL", "MODEL"];
                ...
                switch (menu) {
                    ...
                    case "MODEL":
                        ...
                        break;
                    case "BOX":
                        this.heightList[3].name = "空间立方体";
                        if (this.editMode) {
                            graphicManager.heightReference = this.graphicHeight;
                            const option = CesiumBox.defaultStyle;
                            option.outline = this.outline;
                            option.outlineColor = Cesium.Color.fromCssColorString(
                                this.outlineColor
                            );
                            option.outlineWidth = parseInt(this.outlineWidth);
                            option.extrudedHeight = this.boxHeight
                            // option.color = Cesium.Color.fromCssColorString(this.polygonColor);
                            graphicManager.material = Cesium.Color.fromCssColorString(
                                this.polygonColor
                            );
        ...
        watch: {
            ...
            boxHeight(h) {
                ...
                //graphicManager.style = { extrudedHeight: h };
                graphicManager.extrudedHeight = h;
            },
            outlineColor(n) {
                if (!n) {
                    return;
